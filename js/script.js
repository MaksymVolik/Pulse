...
$(document).ready(function () {
	...
	toggleSlide('.catalog-item__img'); // Добавляет клик по картинке для перехода на вкладку подробнее
		...
		$(form).validate({
			...
			messages: {
				name: {
					...
					minlength: jQuery.validator.format("Введіть неменше {0} символів!")
				},
				phone: "Введіть свій номер телефону",
				email: {
					required: "Введіть свою пошту",
					email: "Ваш email адрес повинен бути в форматі name@domain.com"
				}
			}
		});
	};
